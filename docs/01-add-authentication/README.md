...
*Note:* This role has been pre-created due to limitations of the Immersion Day environment. Skip to the next step, the role definition is left here just so you know what it looks like :).
...
1. In Postman, make sure to [disable SSL checking](https://stackoverflow.com/questions/32100271/how-to-turn-off-all-ssl-checks-for-postman-for-a-specific-site), this is to ignore the nib firewalls MITM, if you were doing this for real talk to Delivery Operations about whitelisting your cognito end point!
